...
class UserProfileGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the UserProfile entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "state":null, "city":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "imagepath":"SAMPLE_TEXT", "firstname":"SAMPLE_TEXT", "lastname":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "username":"SAMPLE_TEXT", "since":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
