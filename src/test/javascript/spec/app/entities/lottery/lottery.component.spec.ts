...
import { LotteryComponent } from 'app/entities/lottery/lottery.component';
import { LotteryService } from 'app/entities/lottery/lottery.service';
import { Lottery } from 'app/shared/model/lottery.model';

describe('Component Tests', () => {
    describe('Lottery Management Component', () => {
        let comp: LotteryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LotteryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.lotteries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
