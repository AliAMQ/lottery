    ...
    describe('Prize Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/prizes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Prize', () => {
                service.create(new Prize(null)).subscribe(received => {
            ...
            it('should update a Prize', () => {
                service.update(new Prize(123)).subscribe(received => {
